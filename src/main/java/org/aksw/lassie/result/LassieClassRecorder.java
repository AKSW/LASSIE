...
public class LassieClassRecorder {
     ...
     */
    public AMapping getInstanceMapping() {
     ...
     */
    public void setInstanceMapping(AMapping instanceMapping) {

        if(this.instanceMapping.getSize() == 0){
            this.instanceMapping = instanceMapping;
        }else{
            for( String url1 : instanceMapping.getMap().keySet()){
                for (String url2 : instanceMapping.getMap().get(url1).keySet()){
                    this.instanceMapping.add(url1, url2, instanceMapping.getConfidence(url1, url1));
                }
            }
        }
    }
