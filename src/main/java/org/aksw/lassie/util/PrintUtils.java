...
public class PrintUtils {
    ...
    public static String toHTMLWithLabels(Map<OWLClassExpression, List<? extends EvaluatedDescription>> mapping, KnowledgeBase source, KnowledgeBase target){
        OWLObjectRenderer sourceRenderer = StringRenderer.Rendering.MANCHESTER_SYNTAX.getRenderer();
        ...
        OWLObjectRenderer targetRenderer = StringRenderer.Rendering.MANCHESTER_SYNTAX.getRenderer();
        if(source.isRemote()){
